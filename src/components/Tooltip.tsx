...
export default function Tooltip({ text }: TooltipProps) {
  return (
    <span className="relative inline-block group ml-1 align-middle">
      <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-gray-200 text-gray-500 text-[10px] font-bold cursor-help leading-none select-none">
        ?
      </span>
